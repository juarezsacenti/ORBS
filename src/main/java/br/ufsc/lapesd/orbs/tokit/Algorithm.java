...
public abstract class Algorithm {
	...
	public abstract Model train(PreparedData preparedData);
	public abstract PredictedResult predict(Model model, final Query query);
	public abstract void nativeEvaluation();
